...
function Signup() {
	...
	const { signup: userSignup } = useContext(AuthContext);
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		if (!login.name || !login.username || !login.email || !login.password) {
	...
	return (
		<>
			...
			<div class='lg:flex relative'>
				<div class='lg:w-1/2 py-10 xl:max-w-screen-sm bg-white'>
						...
						<div class='mt-12'>
							<form onSubmit={handleSubmit}>
								<div className='mb-8'>
									...
									<input
										class='w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 bg-transparent'
										type='text'
										value={login.name}
										name='name'
